        ...
        private void btnXuatExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (save.ShowDialog() == DialogResult.OK)
                {
                    ...
                    chageRange.FormulaR1C1 = "Trường tiểu học Tiên Dược";
                    ...
                    chageRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                    chageRange.FormulaR1C1 = "Xã Tiên Dược";
                    chageRange.RowHeight = 20;
                    chageRange.Font.Size = 12;
                    ...
                    chageRange.FormulaR1C1 = "Huyện Sóc Sơn";
                    chageRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                    chageRange.Font.Size = 12;
                    ...
                    chageRange.FormulaR1C1 = "Hà Nội, Ngày " + date[0] + " tháng " + date[1] + " năm " + date[2];
                    chageRange.RowHeight = 20;
                    chageRange.Font.Name = "Time New Roman";
                    //
        ...
        private void btnXuat_Click(object sender, EventArgs e)
        {
            if (rdoKhuyetTat.Checked == true)
            {
                ...
                if (save.ShowDialog() == DialogResult.OK)
                {
                    ...
                    xlWorkSheet.get_Range("a1", "c1").Merge(false);
                    chageRange = xlWorkSheet.get_Range("a1", "c1");
                    chageRange.FormulaR1C1 = "Trường tiểu học Tiên Dược A";
                    chageRange.RowHeight = 20;
                    chageRange.Font.Size = 12;
                    chageRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                    ...
                    chageRange = xlWorkSheet.get_Range("a2", "c2");
                    chageRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                    chageRange.FormulaR1C1 = "Năm học 2020-2021";
                    chageRange.RowHeight = 20;
                    chageRange.Font.Size = 12;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (save.ShowDialog() == DialogResult.OK)
                {
                    ...
                    chageRange.FormulaR1C1 = "Tỉnh Hà Nội";
                    chageRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                    chageRange.Font.Size = 12;
